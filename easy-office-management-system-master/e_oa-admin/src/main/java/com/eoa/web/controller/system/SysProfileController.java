...
import com.eoa.common.utils.file.MimeTypeUtils;
import com.eoa.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(EoaConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
